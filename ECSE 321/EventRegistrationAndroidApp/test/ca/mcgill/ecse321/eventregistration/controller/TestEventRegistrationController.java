...
public class TestEventRegistrationController {
	...
	public static void setUpBeforeClass() throws Exception {
		PersistenceXStream.setFilename("test" + File.separator + "ca"
				+ File.separator + "mcgill" + File.separator
				+ "ecse321" + File.separator + "eventregistration" 
				+ File.separator + "controller" + File.separator
				+ "data.xml");
		...
		PersistenceXStream.setAlias("managaer", RegistrationManager.class);
	...
	private void checkResultRegister(String nameP, String nameE, Date eventDate, Time startTime, Time endTime, RegistrationManager rm2) {
		...
		assertEquals(rm2.getEvent(0), rm2.getRegistration(0).getEvnet());
