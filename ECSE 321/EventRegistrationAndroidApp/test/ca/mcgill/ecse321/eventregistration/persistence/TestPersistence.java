...
public class TestPersistence {
	...
	public void test() {
		...
		PersistenceXStream.setFilename("test" + File.separator + "ca" + File.separator + "mcgill" + File.separator 
				+ "ecse321" + File.separator + "eventregistration" + File.separator + "persistence" 
		...
		assertEquals(rm.getEvent(0), rm.getRegistration(0).getEvnet());
		assertEquals(rm.getParticipant(0), rm.getRegistration(0).getParticipant());
		assertEquals(rm.getEvent(0), rm.getRegistration(1).getEvnet());
